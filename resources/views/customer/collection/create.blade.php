...
<div class="max-w-4xl mx-auto py-8">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-400 text-sm mt-1">Masukkan detail kartu Pokémon baru ke dalam antrean koleksimu.</p>
    </div>
    ...
    <form action="{{ route('collection.insert') }}" method="POST" enctype="multipart/form-data" class="bg-gray-800 p-8 rounded-2xl border border-gray-700 shadow-xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                <label class="block mb-2 text-sm font-medium text-white">Element Type <span class="text-gray-400 text-xs font-normal">(Kosongkan jika Trainer/Energy)</span></label>
            ...
            <div class="md:col-span-2">
                ...
                <p class="mt-1 text-xs text-gray-400">Isi angka 1-5 jika ingin kartu ini dipajang di Hall Of Fame.</p>
            </div>
            
        </div>

        <div class="mb-8">
            <label class="block mb-2 text-sm font-medium text-white">Foto Mentah Kartu <span class="text-red-500">*</span></label>
